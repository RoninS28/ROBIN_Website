            ...
            <div className={classes.stepDescription}>
                    ...
                    <div>
                        <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                            ...
                            <Typography style={{position:"relative",right:"0",color:"green"}}><DoneIcon/></Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                            <Typography>
                        ...
                        <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                            ...
                            id="panel2bh-header"
                            >
                            <Typography sx={{ width: '33%', flexShrink: 0 }}>Casting</Typography>
                            <Typography style={{position:"relative",right:"0",color:"green"}}><DoneIcon/></Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                            <Typography>
                        ...
                        <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                            ...
                            id="panel4bh-header"
                            >
                            <Typography sx={{ width: '33%', flexShrink: 0 }}>Machining</Typography>
                            <Typography style={{position:"relative",right:"0",color:"red"}}><AccessTimeIcon/></Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                            <Typography>
                                Nunc vitae orci ultricies, auctor nunc in, volutpat nisl. Integer sit
                        ...
                        <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                            ...
                            id="panel4bh-header"
                            >
                            <Typography sx={{ width: '33%', flexShrink: 0 }}>Finishing</Typography>
                            <Typography style={{position:"relative",right:"0",color:"red"}}><AccessTimeIcon/></Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                            <Typography>
