    ...
    return (
        <Router>
            ...
            <main >
               ...
               <Route path='/manufacture' exact component={ManufactureSelect}></Route>
               <Route path='/manufacturehistory/:id' exact component={ManufactureHistory}></Route>
              
               <Route path='/buyaccessories' exact component={BuyAccessories} ></Route>
               <Route path='/buycat/:id' exact component={BuyCategory}></Route>
               <Route path='/buyitem/:id' exact component={BuyItem}></Route>
               <Route path='/buycart' exact component={BuyCart}></Route>
