...
function ServicemanComplaint() {
    return (
        <div style={{padding:'1rem'}}>
        <div style={{display:"flex",justifyContent:"center",alignItems:'center'}}>
            <Card style={{height:"auto",width:"40vw"}}>
                <CardContent>
                ...
                <CardActions style={{
                    ...
                    <Button variant="contained" color="secondary" style={{align:'right'}}>Call</Button>
...
export default ServicemanComplaint